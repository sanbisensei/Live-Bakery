          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-2xl p-6 border border-beige-border">
              ...
              <p className="font-body text-sm text-cocoa-soft leading-relaxed">
                Every cake is made the morning of delivery — no freezing,
                no shortcuts.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-beige-border">
              ...
              <p className="font-body text-sm text-cocoa-soft leading-relaxed">
                No cards, no bKash needed. Just pay in cash when your
                order arrives.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-beige-border">
              ...
              <p className="font-body text-sm text-cocoa-soft leading-relaxed">
                Choose from multiple sizes or contact us for a fully
                custom order.
              </p>
            </div>
          </div>
